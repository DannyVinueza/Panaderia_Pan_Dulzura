...
namespace Prueba_AccesoDatos
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            // Listar categorías
            Console.WriteLine("**Listado de categorías ListarCategorias:**");
            DataTable dt =  categoriaDAO.ListarCategorias();
            List<Categoria> categorias = new List<Categoria>();
            List<Categoria> categorias2 = categoriaLogica.ObtenerCategoriasList();

            Console.WriteLine("**Listado de categorías ObtenerCategoriasList:**");
            foreach (Categoria categoria in categorias2)
            {
                Console.WriteLine($"ID: {categoria.ID_categoria} - Nombre: {categoria.Nombre}");
            }
            ...
            //    Console.WriteLine($"ID: {row["ID_categoria"]} - Nombre: {row["Nombre"]}");
            //}
